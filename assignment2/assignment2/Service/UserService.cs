...
namespace assignment2.Service
{
    public class UserService : IUserService
    {
        ...
        {
            if(!UserRepository.RegisteredUsers.TryAdd(registerDTO.UserName, registerDTO))
            {
        ...
        public UserDetailsResponseDTO GetUserDetails()
        {
            ...
            RegisterDTO registerDTO = UserRepository.RegisteredUsers[username];

            UserDetailsResponseDTO userDetailsResponse =new UserDetailsResponseDTO(registerDTO.UserName,registerDTO.Email,registerDTO.Name,registerDTO.AddressLine1,registerDTO.AddressLine2,registerDTO.PhoneNumber);
